...
const roleBadgeClass: Record<string, string> = {
    ...
    administrativo:
        'bg-sky-100 text-sky-700 border border-sky-200 dark:bg-sky-900/30 dark:text-sky-300 dark:border-sky-700',
};
    ...
    <TransitionRoot appear :show="show" as="template">
        <Dialog @close="emit('close')" class="relative z-50">
            ...
            <div class="fixed inset-0 flex items-center justify-center p-6">
                ...
                >
                    <DialogPanel
                        class="w-full overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10"
                    >
                        <!-- HEADER -->
                        <div
                        ...
                        >
                            ...
                            <div class="relative flex items-center gap-3">
                                <div
                                    class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white/15 text-sm font-bold text-white ring-1 ring-white/25"
                                >
                        ...
                        <div class="space-y-5 p-6">
                            ...
                            <div class="space-y-1.5">
                                <label
                                    class="flex items-center gap-1.5 text-xs font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400"
                                >
                                    <User class="h-3.5 w-3.5 text-[#68c8fb]" />
                                    Nombre completo
                                    <span class="ml-auto font-normal text-red-400 normal-case">
                                        *
                                    </span>
                                </label>
                                <input
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    <select
                                        v-model="form.role"
                                        :class="[
                                            'w-full appearance-none rounded-xl border border-gray-200 bg-gray-50 py-2.5 pr-8 pl-3.5 text-sm text-gray-900 transition-all focus:border-[#087ab1] focus:bg-white focus:ring-2 focus:ring-[#68c8fb]/20 focus:outline-none dark:border-gray-600 dark:bg-gray-700/60 dark:text-gray-100 dark:focus:border-[#68c8fb] dark:focus:bg-gray-700',
                                            form.errors.role ? inputErrorClass : '',
                                        ]"
                                    >
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    ...
                                    <span
                                        v-else
                                        class="ml-auto font-normal text-gray-400 normal-case dark:text-gray-500"
                                    >
                        ...
                        <!-- FOOTER -->
                        <div
                            class="flex items-center justify-between border-t border-gray-100 bg-gray-50/70 px-6 py-4 dark:border-gray-700 dark:bg-gray-800/50"
                        >
                            <p class="text-xs text-gray-400 dark:text-gray-500">
                                <span class="text-red-400">*</span> Los campos marcados son
                                requeridos
                            </p>
