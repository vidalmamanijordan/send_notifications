...
import { BookMarked, Hash, Star } from 'lucide-vue-next';
                            ...
                            <div class="relative flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#68c8fb]">
                                        {{ isEdit ? 'Modifica los datos del curso' : 'Completa los campos para crear un nuevo curso' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5 p-6">
                            ...
                            <div class="space-y-1.5">
                                <label class="flex items-center gap-1.5 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                                    <BookMarked class="h-3.5 w-3.5 text-[#68c8fb]" />
                            ...
                            <div class="space-y-1.5">
                                <label class="flex items-center gap-1.5 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                                    <Star class="h-3.5 w-3.5 text-[#68c8fb]" />
                                    Créditos <span class="ml-auto font-normal text-red-400 normal-case">*</span>
                                </label>
                                <input
                                    ...
                                    placeholder="Ej: 3"
                                    class="w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 transition-all focus:border-[#087ab1] focus:bg-white focus:ring-2 focus:ring-[#68c8fb]/20 focus:outline-none"
                                    :class="{ 'border-red-300 bg-red-50 focus:border-red-400 focus:ring-red-100': form.errors.credits }"
                                />
                                <p v-if="form.errors.credits" class="text-xs text-red-500">{{ form.errors.credits }}</p>
                            </div>
                        </div>
