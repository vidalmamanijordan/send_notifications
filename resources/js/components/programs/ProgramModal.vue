...
import { BookOpen, Hash, Layers } from 'lucide-vue-next';
...
const form = useForm({
    name: '',
    code: '',
    level: 'undergraduate' as 'undergraduate' | 'postgraduate',
});
                            ...
                            <div class="relative flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#68c8fb]">
                                        {{ isEdit ? 'Modifica los datos del programa' : 'Completa los campos para crear un nuevo programa' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5 p-6">
                            ...
                            <div class="space-y-1.5">
                                <label class="flex items-center gap-1.5 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                                    <BookOpen class="h-3.5 w-3.5 text-[#68c8fb]" />
                            ...
                            <div class="space-y-1.5">
                                <label class="flex items-center gap-1.5 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                                    <Layers class="h-3.5 w-3.5 text-[#68c8fb]" />
                                    Nivel Académico <span class="ml-auto font-normal text-red-400 normal-case">*</span>
                                </label>
                                <select
                                    v-model="form.level"
                                    ...
                                    :class="{ 'border-red-300 bg-red-50 focus:border-red-400 focus:ring-red-100': form.errors.level }"
                                >
