...
import { GraduationCap, Hash } from 'lucide-vue-next';
                            ...
                            <div class="relative flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#68c8fb]">
                                        {{ isEdit ? 'Modifica los datos de la facultad' : 'Completa los campos para crear una nueva facultad' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-5 p-6">
                            ...
                            <div class="space-y-1.5">
                                <label class="flex items-center gap-1.5 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                                    <GraduationCap class="h-3.5 w-3.5 text-[#68c8fb]" />
